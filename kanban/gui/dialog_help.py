...
class AboutDialog(QDialog):
	...
	def __init__(self, parent: Optional[QDialog] = None, version: str = __version__):
		...
		self.usage_label = QLabel(
			...
			'<b>6.</b> Use the Due Date View, Archived Cards dialog, and Board Statistics screens to review progress and deadlines.'
		)
...
def build_command_line_guide_html() -> str:
	...
	return (
		...
		'<li><b>show-board</b>, <b>create-card</b>, <b>edit-card</b>, <b>add-subcard</b>, <b>move-card</b>, <b>delete-card</b>, note commands, archive commands, and checklist item commands: automate current-board work without opening the menu CLI.</li>'
		...
		'<ul style="margin: 0 0 0 18px; padding: 0;">'
		'<li><b>Cards</b>: create, edit, move, delete, search, filter by priority, filter by assignee, add tags, manage checklists, manage notes, view card details, archive done cards, manage archived cards, and add subcards.</li>'
		...
		'<p style="margin: 10px 0 0 0;">Checklist input accepts pipe-delimited items in the menu CLI, and direct commands can target individual checklist items by the ids printed in <b>card-details</b>. Notes can be edited in the menu CLI or by direct note commands.</p>'
